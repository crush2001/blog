...
//本地测试
var url="";
var fileurl="http://localhost:8080/upload/";
var host=window.location.host;
//服务器测试 放到服务器上使用就把上面url注释  把下面 var url 前面的 // 去掉即可
// var url="http://test.okcoder.cn:8081/ssm_war"
// var requestALL={
//     marketing:{
//         //添加用户
//
//         add:url+"/account/saveAccount",
//         //获取用户
//         list:url+"/account/list",
//         //搜索用户
//         list1:url+"/account/accountlikename",
//         //修改个人信息
//         upd:url+'/account/userupdata',
//         //查找用户
//         find:url+'/account/findbyuser',
//         //修改用户信息
//         upd1:url+'/account/userupdataz',
//         //删除
//         del:url+'/account/accountdel',
//         sreach:url+'/account/accountlikename',
//         upd2:url+"/account/updateaccount"
//     }
// }