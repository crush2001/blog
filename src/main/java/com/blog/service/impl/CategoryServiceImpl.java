...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Page<Category> queryByPage(Category category, PageRequest pageRequest) {
     ...
     @Override
    public List<Category> queryAllByLimits(Category category, int offset, int pageSize) {
        return this.categoryDao.queryAllByLimits(category,(offset-1)*pageSize,pageSize);
    }
